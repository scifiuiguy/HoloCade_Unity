...
<img src="Packages/com.ajcampbell.holocade/Runtime/images/holocade-logo.png" alt="HoloCade Logo" width="100%">
...
HoloCade is a comprehensive SDK for developing VR and AR Location-Based Entertainment (LBE) experiences. This repository contains the **Unity 6 LTS** implementation of the HoloCade SDK.
...
**Low-Level APIs:**
- [VRPlayerTransport README](https://github.com/scifiuiguy/holocade_unity/blob/main/Packages/com.ajcampbell.holocade/Runtime/Core/VRPlayerTransport/README.md) - `Packages/com.ajcampbell.holocade/Runtime/Core/VRPlayerTransport/README.md`
- [Input README](https://github.com/scifiuiguy/holocade_unity/blob/main/Packages/com.ajcampbell.holocade/Runtime/Core/Input/README.md) - `Packages/com.ajcampbell.holocade/Runtime/Core/Input/README.md`
- [VOIP README](https://github.com/scifiuiguy/holocade_unity/blob/main/Packages/com.ajcampbell.holocade/Runtime/VOIP/README.md) - `Packages/com.ajcampbell.holocade/Runtime/VOIP/README.md`
- [EmbeddedSystems README](https://github.com/scifiuiguy/holocade_unity/blob/main/Packages/com.ajcampbell.holocade/Runtime/EmbeddedSystems/README.md) - `Packages/com.ajcampbell.holocade/Runtime/EmbeddedSystems/README.md`

**Firmware Examples:**
- [FirmwareExamples README](https://github.com/scifiuiguy/holocade_unity/blob/main/Packages/com.ajcampbell.holocade/FirmwareExamples/README.md) - `Packages/com.ajcampbell.holocade/FirmwareExamples/README.md`
- [GunshipExperience README](https://github.com/scifiuiguy/holocade_unity/blob/main/Packages/com.ajcampbell.holocade/FirmwareExamples/GunshipExperience/README.md) - `Packages/com.ajcampbell.holocade/FirmwareExamples/GunshipExperience/README.md`
- [FlightSimExperience README](https://github.com/scifiuiguy/holocade_unity/blob/main/Packages/com.ajcampbell.holocade/FirmwareExamples/FlightSimExperience/README.md) - `Packages/com.ajcampbell.holocade/FirmwareExamples/FlightSimExperience/README.md`
- [EscapeRoom README](https://github.com/scifiuiguy/holocade_unity/blob/main/Packages/com.ajcampbell.holocade/FirmwareExamples/EscapeRoom/README.md) - `Packages/com.ajcampbell.holocade/FirmwareExamples/EscapeRoom/README.md`
- [Base Examples README](https://github.com/scifiuiguy/holocade_unity/blob/main/Packages/com.ajcampbell.holocade/FirmwareExamples/Base/Examples/README.md) - `Packages/com.ajcampbell.holocade/FirmwareExamples/Base/Examples/README.md`
- [Base Templates README](https://github.com/scifiuiguy/holocade_unity/blob/main/Packages/com.ajcampbell.holocade/FirmwareExamples/Base/Templates/README.md) - `Packages/com.ajcampbell.holocade/FirmwareExamples/Base/Templates/README.md`
...
If you've cloned the `HoloCade_Unity` repository, everything is already configured:

1. **Open the project in Unity**
2. **HoloCade package** is already in `Packages/com.ajcampbell.holocade/`
...
> **💡 Note:** If you cloned the repo, HoloCade is already set up as a local package. All dependencies will automatically install when you first open the project.
...
<img src="Packages/com.ajcampbell.holocade/Runtime/images/standard-layout.png" alt="Standard Pop-up Layout" width="100%">
...
<img src="Packages/com.ajcampbell.holocade/Runtime/images/holocade_standard_layout_pocket_door_frame.png" alt="HoloCade Standard Layout Pocket Door Frame CAD Model" width="100%">
...
<img src="Packages/com.ajcampbell.holocade/Runtime/images/holocade_standard_layout_framing.png" alt="HoloCade Standard Layout Framing CAD Model" width="100%">
...
**📚 Documentation:**
- [HoloCadeAI API README](https://github.com/scifiuiguy/holocade_unity/blob/main/Packages/com.ajcampbell.holocade/Runtime/HoloCadeAI/README.md) - Low-level AI API documentation (LLM, ASR, TTS, container management)
- [AIFacemask Experience README](https://github.com/scifiuiguy/holocade_unity/blob/main/Packages/com.ajcampbell.holocade/Runtime/ExperienceTemplates/AIFacemaskExperience/README.md) - Complete AIFacemask experience documentation
...
5. Enter the Git URL:
   ```
   https://github.com/scifiuiguy/holocade_unity.git?path=Packages/com.ajcampbell.holocade
   ```
6. Click **"Add"**
7. Unity will download and install the package

> **📌 Note:** HoloCade is currently **version 0.1.0**. Version tags are not yet available, so the Git URL above will pull the latest commit from the `main` branch. Once version tags are added, you can pin to specific versions using `#v0.1.0` syntax. HoloCade uses **Semantic Versioning** (SemVer): MAJOR.MINOR.PATCH (e.g., 0.1.0 = minor changes, 1.0.0 = major/breaking changes).

**For a specific branch:**
```
https://github.com/scifiuiguy/holocade_unity.git?path=Packages/com.ajcampbell.holocade#main
```

**For a specific version tag (when available):**
```
https://github.com/scifiuiguy/holocade_unity.git?path=Packages/com.ajcampbell.holocade#v0.1.0
```

**Using SSH:**
```
git@github.com:scifiuiguy/holocade_unity.git?path=Packages/com.ajcampbell.holocade
```
...
3. Look for **"HoloCade SDK"** (v0.1.0)
...
- **Solution:** Check that `package.json` exists in `Packages/com.ajcampbell.holocade/`
...
<img src="Packages/com.ajcampbell.holocade/Runtime/images/HCUS_case.png" width="100%">
...
<img src="Packages/com.ajcampbell.holocade/Runtime/images/HCUS-alpha-schematic.png" width="100%">

Full hardware design details, KiCAD files, and pin maps live in the dedicated [Universal Shield README](Packages/com.ajcampbell.holocade/FirmwareExamples/PCBs~/HoloCade_Universal_Shield/README.md). Refer to that doc whenever you need schematic/PCB specifics or manufacturing notes.

<img src="Packages/com.ajcampbell.holocade/Runtime/images/holocade-alpha-pcb.png" width="100%">
...
<img src="Packages/com.ajcampbell.holocade/Runtime/images/child-shield.png" width="100%">
